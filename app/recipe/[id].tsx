  ...
  useEffect(() => {
    const checkIfSaved = async () => {
      try {
        ...
        const isRecipeSaved = favourites.some((fav:Recipe) => fav.recipeId === parseInt(recipeId));
          ...
          <View style={recipeDetailStyles.sectionContainer}>
            <View style={recipeDetailStyles.sectionTitleRow}>
              ...
              <View style={recipeDetailStyles.countBadge}>
                <Text style={recipeDetailStyles.countText}>{recipe?.ingredients && recipe.ingredients.length}</Text>
              </View>
            </View>
